...
<div class="card shadow mb-4">
                     ...
                     <div class="form-group">
                        ...
                        <select class="form-control" name="category" required>
                            ...
                            <option @if($article->category_id==$category->id) selected @endif value="{{$category->id}}">{{$category->name}}</oprion>
                            @endforeach
                        </select>
                     </div>
                     <div class="form-group">
                     ...
                     <div class="form-group">
                        ...
                        <textarea id="editor" name="content" class="form-control" row="4" >{!! $article->content !!}</textarea>
                     </div>
                     <div class="form-group">
